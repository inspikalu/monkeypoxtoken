...
import { FaArrowRight, FaLock, FaExchangeAlt, FaInfoCircle } from 'react-icons/fa';
    ...
    <div>
      ...
      <div className="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        >
          ...
          <p className="text-lg text-gray-400 mb-12 max-w-3xl mx-auto">
            Blending memecoin and NFT cultures into one revolutionary platform. Trade, swap, and lock both fungible and non-fungible assets in a seamless ecosystem.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-gray-800/30 backdrop-blur rounded-xl p-6">
              <h3 className="text-2xl font-bold text-yellow-400">1B</h3>
              <p className="text-gray-400">Total Supply</p>
            </div>
            <div className="bg-gray-800/30 backdrop-blur rounded-xl p-6">
              <h3 className="text-2xl font-bold text-yellow-400">500</h3>
              <p className="text-gray-400">$POXNFT Supply</p>
            </div>
            <div className="bg-gray-800/30 backdrop-blur rounded-xl p-6">
              <h3 className="text-2xl font-bold text-yellow-400">2M</h3>
              <p className="text-gray-400">$POX per NFT</p>
            </div>
          </div>
        </motion.div>
      </div>
      ...
      <section className="py-20 px-4 bg-gray-900/50">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <h2 className="text-4xl font-bold text-yellow-400 mb-6">Tokenomics</h2>
            <p className="text-gray-400 max-w-3xl mx-auto">
              POX introduces a revolutionary tokenomics model that bridges the gap between fungible tokens and NFTs
            </p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
            ...
            >
              <h3 className="text-2xl font-bold text-yellow-400 mb-6">Token Details</h3>
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center border-b border-gray-700 pb-4">
                  ...
                  <span className="text-white">1,000,000,000 $POX</span>
                </div>
                <div className="flex justify-between items-center border-b border-gray-700 pb-4">
                  <span className="text-gray-400">NFT Supply</span>
                  <span className="text-white">500 $POXNFT</span>
                </div>
                <div className="flex justify-between items-center">
                  <span className="text-gray-400">Swap Rate</span>
                  <span className="text-white">1 $POXNFT = 2M $POX</span>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="bg-gray-800/30 backdrop-blur rounded-xl p-8"
            >
              <h3 className="text-2xl font-bold text-yellow-400 mb-6">MPL-404 Features</h3>
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  <FaExchangeAlt className="text-yellow-400 text-xl mt-1" />
                  <div>
                    <h4 className="text-white font-semibold mb-2">Seamless Swaps</h4>
                    <p className="text-gray-400">Easily swap between fungible and non-fungible assets</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <FaLock className="text-yellow-400 text-xl mt-1" />
                  <div>
                    <h4 className="text-white font-semibold mb-2">Asset Locking</h4>
                    <p className="text-gray-400">Lock your assets for enhanced security and earning potential</p>
                  </div>
                </div>
                <div className="flex items-start gap-4">
                  <FaInfoCircle className="text-yellow-400 text-xl mt-1" />
                  <div>
                    <h4 className="text-white font-semibold mb-2">Hybrid Assets</h4>
                    <p className="text-gray-400">Unique token + NFT hybrid system with full interchangeability</p>
                  </div>
                </div>
              </div>
            </motion.div>
