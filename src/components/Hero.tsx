...
import { FaArrowRight, FaLock, FaExchangeAlt, FaInfoCircle, FaRocket } from 'react-icons/fa';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 max-w-3xl mx-auto">
              MoonLambo introduces a revolutionary tokenomics model that bridges the gap between fungible tokens and NFTs
            </p>
          </motion.div>
            ...
            >
              ...
              <div className="space-y-4">
                ...
                <div className="flex justify-between items-center border-b border-gray-700 pb-4">
                  ...
                  <span className="text-white">18,446,744,073.709551615 $MOONL</span>
                </div>
                <div className="flex justify-between items-center border-b border-gray-700 pb-4">
